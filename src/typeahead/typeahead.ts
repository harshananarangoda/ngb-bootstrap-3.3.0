...
export class NgbTypeahead implements ControlValueAccessor,
  ...
  */
  ...
  constructor(
      ...
      config: NgbTypeaheadConfig, private ngZone: NgZone, private _live: Live) {
  ...
  private _openPopup() {
    if (!this.isPopupOpen()) {
      ...
      ClosePopup(this.ngZone , document, this._windowRef.location.nativeElement, () => this.dismissPopup(), this._closed$);
    }
  }
